...
export class AppSyncEventsChatStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    // Output the Events API endpoint
    new cdk.CfnOutput(this, "EventsApiHttpDns", {
      value: eventsApi.httpDns,
      description: "The URL of the Events API endpoint",
      exportName: "EventsApiEndpoint",
    });
