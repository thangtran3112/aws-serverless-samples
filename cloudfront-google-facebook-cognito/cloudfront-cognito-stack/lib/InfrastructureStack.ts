...
export class InfrastructureStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const viewerRequest = new cloudfront.experimental.EdgeFunction(
      this,
      "viewerRequest",
      {
      ...
      defaultBehavior: {
        ...
        originRequestPolicy: new cloudfront.OriginRequestPolicy(
          ...
          "queryStringOnly",
          {
            ...
            cookieBehavior:
              cloudfront.OriginRequestCookieBehavior.allowList("token"),
          }
        ),
        edgeLambdas: [
          {
    ...
    const secret = new secretsmanager.Secret(this, "Secret", {
      ...
      secretObjectValue: {
        ...
        DistributionDomainName: SecretValue.unsafePlainText(
          cfDistro.distributionDomainName
        ),
      },
    });
    ...
    const userPoolIdentityProviderGoggle =
      new cognito.UserPoolIdentityProviderGoogle(this, "GoogleIDP", {
        clientId: thirdPardyIdsSecret
          .secretValueFromJson("GoogleAppId")
          .unsafeUnwrap(),
        clientSecret: thirdPardyIdsSecret
          .secretValueFromJson("GoogleAppSecret")
          .unsafeUnwrap(),
        userPool: userPool,
